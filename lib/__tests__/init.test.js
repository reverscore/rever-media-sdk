...
describe('Init SDK', () => {
  ...
  it('should return an instance of rever SDK initialized with the fetched organization data, Rever token and Rever URL', async () => {
    ...
    expect(reverMedia).toBeInstanceOf(ReverMedia);
